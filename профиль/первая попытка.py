...
woman_name = ['Агния', 'Аделина', 'Аида', 'Аксинья', 'Александра',
...
man_name = ['Александр', 'Дмитрий', 'Максим', 'Сергей', 'Андрей', 'Алексей',
...
woman_surname = ['Иванова', 'Петрова', 'Смирнова', 'Кузнецова', 'Васильева',
...
man_surname = ['Кравченко', 'Сергеевич', 'Сорокин', 'Данилов', 'Власов',
...
city = ['Москва', 'Санкт-Петербург', 'Новосибирск', 'Екатеринбург', 'Казань',
        ...
        'Астрахань', 'Киров', 'Пенза', 'Севастополь', 'Балашиха', 'Липецк']  # город проживания и обучения
mail = ['@Box.az', '@Byke.com', '@Chez.com', '@Email.ru', '@Gmail.com', '@GMX.net/mail/',
...
mail_services = choices(mail)  # случайный выбор почтового сервиса


def my_func():
    if gender == 'w':
        my_name = choices(woman_name)  # случайный выбор имени
        my_surname = choices(woman_surname)
        ...
        my_login_eng_1 = "".join(my_login_eng) + '.' + "".join(str(age)) + "".join(
            mail_services)  # создание логина с датой
        ...
        my_name_1 = choices(man_name)
        my_surname_1 = choices(man_surname)
